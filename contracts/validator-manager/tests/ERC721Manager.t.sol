...
// import {ERC721Manager} from "../ERC721Manager.sol";
// import {ERC721ManagerSettings} from "../interfaces/IERC721Manager.sol";

// contract ERC721TokenStakingManagerTest is IERC721Receiver {
//     using SafeERC20 for IERC20;

//     ERC721Manager public app;

//     IERC721 public stakingToken;
//     IERC20 public rewardToken;
//     EthereumVaultConnector public evc;
//     TrackingRewardStreams public balanceTracker;
//     ERC721TokenStakingManager public erc721TokenStakingManager;
...
//         erc721TokenStakingManager.initializeValidatorSet(_defaultConversionData(), 0);
//     }
...
//     //     vm.expectRevert(
//     //         abi.encodeWithSelector(
//     //             PoSValidatorManager.unlockDurationNotPassed.selector, block.timestamp
//     //         )
//     //     );
//     //     _completeEndNFTDelegation(
//     //         DEFAULT_DELEGATOR_ADDRESS,
...
//     function _defaultSettings() internal pure returns (ERC721ManagerSettings memory) {
//         return ERC721ManagerSettings({
//             _token: address(0),
//             _posManager: address(0),
//             minimumNFTAmount: 1,
//             maximumNFTAmount: 50,
//             balanceTrackerNFT: address(0)
//         });
//     }

//     function _setUp() internal override returns (IValidatorManager) {
//         // Construct the object under test
//         app = new ERC721Manager(ICMInitializable.Allowed);

//         stakingToken = new ExampleERC721();
//         rewardToken = new ExampleERC20();
//         erc721TokenStakingManager = new ERC721TokenStakingManager(ICMInitializable.Allowed);

//         stakingToken.setApprovalForAll(address(app), true);

//         PoSValidatorManagerSettings memory defaultPoSSettings = _defaultPoSSettings();
//         ERC721ManagerSettings memory defaultSettings = defaultSettings();
...
//         defaultSettings._token = stakingToken;
//         defaultSettings._posManager = erc721TokenStakingManager;
//         defaultSettings.balanceTrackerNFT = balanceTrackerNFT;
...
//         balanceTracker.registerReward(address(erc721TokenStakingManager), address(rewardToken), 0, amounts);
//         balanceTracker.enableReward(address(erc721TokenStakingManager), address(rewardToken));
...
//         erc721TokenStakingManager.initialize(defaultPoSSettings, app);
//         app.initialize(defaultSettings);
